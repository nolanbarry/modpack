import { GameVersion, Project, ProjectVersion } from '@xmcl/modrinth'
import { randomBytes } from 'crypto'
import fs from 'fs-extra'
import path from 'path'
import { fileURLToPath } from 'url'
import zod from 'zod'
import { defaultMods, gameVersions, getBestVersion, getProject, getProjectFromVersionId, loaders } from './modrinth.js'
...
export async function selectVersion(initialPrompt: string = 'Version:'): Promise<GameVersion> {
